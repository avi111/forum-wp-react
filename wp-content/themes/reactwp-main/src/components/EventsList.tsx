      ...
      <div className="space-y-4">
        {events.map((event) => (
          <div
            ...
            className="flex flex-col sm:flex-row gap-6 bg-white border border-slate-100 p-6 rounded-xl shadow-sm items-center hover:shadow-md transition-shadow animate-fade-in cursor-pointer group"
          >
